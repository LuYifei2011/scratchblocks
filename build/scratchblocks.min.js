...
var scratchblocks = (function () {
  ...
  */
  ...
  var dropdowns = [{
    id: "MOTION_GOTO_POINTER",
    value: "mouse-pointer"
  }, {
    id: "MOTION_GOTO_RANDOM",
    value: "random position"
  }, {
    id: "MOTION_GLIDETO_POINTER",
    value: "mouse-pointer"
  }, {
    id: "MOTION_GLIDETO_RANDOM",
    value: "random position"
  }, {
    id: "MOTION_POINTTOWARDS_POINTER",
    value: "mouse-pointer"
  }, {
    id: "MOTION_POINTTOWARDS_RANDOM",
    value: "random direction"
  }, {
    id: "MOTION_SETROTATIONSTYLE_LEFTRIGHT",
    value: "left-right"
  }, {
    id: "MOTION_SETROTATIONSTYLE_DONTROTATE",
    value: "don't rotate"
  }, {
    id: "MOTION_SETROTATIONSTYLE_ALLAROUND",
    value: "all around"
  }, {
    ...
    id: "LOOKS_GOTOFRONTBACK_FRONT",
    value: "front"
  }, {
    id: "LOOKS_GOTOFRONTBACK_BACK",
    value: "back"
  }, {
    id: "LOOKS_GOFORWARDBACKWARDLAYERS_FORWARD",
    value: "forward"
  }, {
    id: "LOOKS_GOFORWARDBACKWARDLAYERS_BACKWARD",
    value: "backward"
  }, {
    ...
    value: "space",
    parents: ["EVENT_WHENKEYPRESSED", "SENSING_KEYPRESSED", "makeymakey.whenKeyPressed"]
  }, {
    ...
    id: "CONTROL_STOP_THIS",
    value: "this script"
  }, {
    id: "CONTROL_STOP_OTHER",
    value: "other scripts in sprite"
  }, {
    id: "CONTROL_CREATECLONEOF_MYSELF",
    value: "myself"
  }, {
    id: "SENSING_TOUCHINGOBJECT_POINTER",
    value: "mouse-pointer"
  }, {
    id: "SENSING_TOUCHINGOBJECT_EDGE",
    value: "edge"
  }, {
    id: "SENSING_DISTANCETO_POINTER",
    value: "mouse-pointer"
  }, {
    id: "SENSING_SETDRAGMODE_DRAGGABLE",
    value: "draggable"
  }, {
    id: "SENSING_SETDRAGMODE_NOTDRAGGABLE",
    value: "not draggable"
  }, {
    id: "SENSING_OF_XPOSITION",
    value: "x position"
    ...
    id: "SENSING_OF_COSTUMENAME",
    value: "costume name"
  }, {
    id: "SENSING_OF_SIZE",
    value: "size"
  }, {
    id: "SENSING_OF_VOLUME",
    value: "volume"
  }, {
    id: "SENSING_OF_BACKDROPNUMBER",
    value: "backdrop #"
    ...
    id: "SENSING_CURRENT_YEAR",
    value: "year"
  }, {
    id: "SENSING_CURRENT_MONTH",
    value: "month"
  }, {
    id: "SENSING_CURRENT_DATE",
    value: "date"
  }, {
    id: "SENSING_CURRENT_DAYOFWEEK",
    value: "day of week"
  }, {
    id: "SENSING_CURRENT_HOUR",
    value: "hour"
  }, {
    id: "SENSING_CURRENT_MINUTE",
    value: "minute"
  }, {
    id: "SENSING_CURRENT_SECOND",
    value: "second"
  }, {
    id: "OPERATORS_MATHOP_ABS",
    value: "abs"
  }, {
    id: "OPERATORS_MATHOP_FLOOR",
    value: "floor"
  }, {
    id: "OPERATORS_MATHOP_CEILING",
    value: "ceiling"
  }, {
    id: "OPERATORS_MATHOP_SQRT",
    value: "sqrt"
  }, {
    id: "OPERATORS_MATHOP_SIN",
    value: "sin"
  }, {
    id: "OPERATORS_MATHOP_COS",
    value: "cos"
  }, {
    id: "OPERATORS_MATHOP_TAN",
    value: "tan"
  }, {
    id: "OPERATORS_MATHOP_ASIN",
    value: "asin"
  }, {
    id: "OPERATORS_MATHOP_ACOS",
    value: "acos"
  }, {
    id: "OPERATORS_MATHOP_ATAN",
    value: "atan"
  }, {
    id: "OPERATORS_MATHOP_LN",
    value: "ln"
  }, {
    id: "OPERATORS_MATHOP_LOG",
    value: "log"
  }, {
    id: "OPERATORS_MATHOP_EEXP",
    value: "e ^"
  }, {
    id: "OPERATORS_MATHOP_10EXP",
    value: "10 ^"
  }, {
    id: "music.drumSnare",
    value: "(1) Snare Drum"
    ...
    id: "wedo2.motorId.a",
    value: "motor A",
    parents: ["wedo2.motorOnFor", "wedo2.motorOn", "wedo2.motorOff", "wedo2.startMotorPower", "wedo2.setMotorDirection"]
  }, {
    id: "wedo2.motorId.b",
    value: "motor B",
    parents: ["wedo2.motorOnFor", "wedo2.motorOn", "wedo2.motorOff", "wedo2.startMotorPower", "wedo2.setMotorDirection"]
  ...
  function getMakeyMakeySequenceDropdowns(dropdowns) {
    var raw = ["left up right", "right up left", "left right", "right left", "up down", "down up", "up right down left", "up left down right", "up up down down left right left right"];
    var result = {};
    raw.forEach(function (value, index) {
      result["makeymakey.sequence." + index] = {
        value: value.replaceAll("left", dropdowns["makeymakey.leftArrowShort"].value).replaceAll("right", dropdowns["makeymakey.rightArrowShort"].value).replaceAll("up", dropdowns["makeymakey.upArrowShort"].value).replaceAll("down", dropdowns["makeymakey.downArrowShort"].value),
    ...
    dropdowns.forEach(function (item) {
      if (!item.parents) {
        if (item.id.startsWith("music.drum")) {
          ...
          var idx = item.id.lastIndexOf("_");
          var parent = idx !== -1 ? item.id.substring(0, idx) : null;
  ...
  function loadLanguage(code, language) {
    ...
    Object.keys(language.dropdowns).forEach(function (name) {
      var nativeName = language.dropdowns[name].value;
      var parents = language.dropdowns[name].parents;
      if (!language.nativeDropdowns[nativeName]) {
        language.nativeDropdowns[nativeName] = [];
      }
      language.nativeDropdowns[nativeName].push({
        id: name,
        parents: parents
      });
    });
  ...
  getDropdowns().forEach(function (info) {
    english.dropdowns[info.id] = {
      value: info.value,
      parents: info.parents || []
    };
  });
  english.dropdowns = _objectSpread2(_objectSpread2(_objectSpread2({}, english.dropdowns), getMakeyMakeySequenceDropdowns(english.dropdowns)), {}, {
  ...
  function narrowByNativeDropdowns(collisions, children, languages) {
    ...
    var valueEntriesMap = new Map();
    var _iterator9 = _createForOfIteratorHelper(languages),
      _step9;
    try {
      for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
        var lang = _step9.value;
        var _iterator12 = _createForOfIteratorHelper(dropdownValues),
          _step12;
        try {
          for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
            var val = _step12.value;
            if (lang.nativeDropdowns && Object.prototype.hasOwnProperty.call(lang.nativeDropdowns, val)) {
              var arr = lang.nativeDropdowns[val];
              if (arr && arr.length) {
                var _valueEntriesMap$get;
                if (!valueEntriesMap.has(val)) {
                  valueEntriesMap.set(val, []);
                }
                // arr: [{ id, parents }] ; merge (keep duplicates harmless)
                (_valueEntriesMap$get = valueEntriesMap.get(val)).push.apply(_valueEntriesMap$get, _toConsumableArray(arr));
              }
            }
          }
        } catch (err) {
    ...
    var filtered = collisions.filter(function (block) {
      var candidates = [block.id, block.selector && block.selector.replace(/^sb3:/, ""), block.selector].filter(Boolean);
      var _iterator10 = _createForOfIteratorHelper(valueEntriesMap.values()),
        _step10;
      try {
        for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
          var entries = _step10.value;
          ...
          try {
            for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
              ...
              var parents = Array.isArray(entry.parents) ? entry.parents : [];
  ...
  function lookupHash(hash, info, children, languages, overrides) {
    var _iterator13 = _createForOfIteratorHelper(languages),
      _step13;
    try {
      var _loop = function _loop() {
          var lang = _step13.value;
          if (Object.prototype.hasOwnProperty.call(lang.blocksByHash, hash)) {
            ...
            if (overrides && overrides.length) {
              ...
              var collisionCategories = new Set(collisions.map(function (b) {
                return b.category;
              }).filter(Boolean));
              var _iterator14 = _createForOfIteratorHelper(overrides),
                _step14;
              try {
                var _loop2 = function _loop2() {
                    ...
                    if (collisionCategories.has(o)) {
                      var matching = collisions.filter(function (b) {
                        return b.category === o;
                      });
                      if (matching.length === 1) {
                        var block = matching[0];
                        // Keep shape filtering consistent with subsequent logic
                        if (info.shape === "reporter" && block.shape !== "reporter" && block.shape !== "ring" || info.shape === "boolean" && block.shape !== "boolean") {
              ...
              var categoryOverride = overrides.find(function (o) {
                return overrideCategories.includes(o);
              });
              if (categoryOverride) {
                var filtered = collisions.filter(function (b) {
                  return b.category === categoryOverride;
                });
                if (filtered.length) {
            ...
            var _iterator15 = _createForOfIteratorHelper(collisions),
              _step15;
            try {
  ...
  function lookupDropdown(name, parentType, languages) {
    var _iterator16 = _createForOfIteratorHelper(languages),
      _step16;
    try {
      for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
        var lang = _step16.value;
        if (Object.prototype.hasOwnProperty.call(lang.nativeDropdowns, name)) {
          var objs = lang.nativeDropdowns[name];
          var _iterator17 = _createForOfIteratorHelper(objs),
            _step17;
          try {
            for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
              var _step17$value = _step17.value,
                id = _step17$value.id,
                parents = _step17$value.parents;
  ...
  function applyOverrides(info, overrides) {
    var _iterator18 = _createForOfIteratorHelper(overrides),
      _step18;
    try {
  ...
  function blockName(block) {
    var words = [];
    var _iterator19 = _createForOfIteratorHelper(block.children),
      _step19;
    try {
  ...
  var Input = /*#__PURE__*/function () {
    ...
    return _createClass(Input, [{
      ...
      value: function stringify() {
        ...
        var text = (this.value ? String(this.value) : "").replace(/([\]\\])/g, "\\$1").replace(/([()])/g, "\\$1").replace(/ v$/, " \\v");
        if (this.hasArrow) {
          text += " v";
        }
  ...
  var Block = /*#__PURE__*/function () {
    function Block(info, children, comment) {
      ...
      this.hasPuzzle = shape === "stack" || shape === "hat" || shape === "cat" || shape === "c-block" || shape === "define-hat";
    ...
    return _createClass(Block, [{
      ...
      value: function stringify(extras) {
        ...
        return this.hasScript ? text + "\n" + (Object.keys(lang.aliases).find(function (key) {
          return lang.aliases[key] === "scratchblocks:end";
    ...
    return _createClass(Script, [{
      ...
      value: function translate(lang) {
        this.blocks.forEach(function (block) {
          return block.translate && block.translate(lang);
        });
      }
    }]);
  }();
  ...
  function paintBlock(info, children, languages) {
    ...
    // paint
    var o = lookupHash(shortHash, info, children, languages, overrides);
    var lang;
    var type;
    if (o) {
      lang = o.lang;
